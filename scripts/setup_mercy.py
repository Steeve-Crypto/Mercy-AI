...
GROUPS: list[tuple[str, list[EnvSpec]]] = [
    ...
    (
        ...
        [
            ...
            EnvSpec("MERCY_DEV_TOOLS", "Enable localhost-only dev tools", "false", choices=("true", "false")),
            EnvSpec("MERCY_AUTO_INIT_STORAGE_SCHEMA", "Allow automatic storage schema creation", "false", choices=("true", "false")),
    ...
    (
        ...
        [
            ...
            EnvSpec("MERCY_ALLOW_DEV_MICROSOFT_IDENTITY_MAP_JSON", "Allow dev/test JSON Microsoft mapping", "false", choices=("true", "false")),
            EnvSpec("MERCY_MICROSOFT_IDENTITY_MAP_JSON", "Dev/test Microsoft to Mercy identity map JSON", secret=True),
