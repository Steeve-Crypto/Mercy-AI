...
const isolatedTenantId = `${baseTenantId}-${runId}`;
const isolatedUserId = `${baseUserId}-${runId}`;
...
process.env.NEXT_PUBLIC_MERCY_ENV ||= process.env.MERCY_ENV;
process.env.NEXT_PUBLIC_MERCY_AUTH_MODE ||= process.env.MERCY_AUTH_MODE;
process.env.MERCY_API_TOKEN ||= "playwright-local-token";
process.env.MERCY_CORE_API_TOKEN ||= process.env.MERCY_API_TOKEN;
process.env.MERCY_E2E_RUN_ID = runId;
process.env.MERCY_TENANT_ID = isolatedTenantId;
process.env.MERCY_USER_ID = isolatedUserId;
